...
<body>
    <div id="shop">
        <div id="head-text">
            <a href="/vuurwerk/admin"><img src="/vuurwerk/shop/img/logo.jpg" height="50" width="50"></a>
            <h1>Vuurwerk</h1>
        </div>
        <div id="nav">
            <nav id="head-nav">
        ...
        <div id="producten">
            <img src="shop/img/logo.jpg">
            <h1>Vuurwerk</h1>
            <h2>De beste vuurwerk winkel van Nederland!</h2>
            <h2>Ga verder en ontdek wat we allemaal hebben!</h2>
        </div>
    </div>
</body>
